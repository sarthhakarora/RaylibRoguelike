...
bool Player::healthUpdate(std::vector<Enemy::enemyStats> &enemies, bool gameActive, int &score)
{
    for (size_t i = 0; i < enemies.size(); i++)
    {
        ...
        // std::cout << playerTimer.timerState << std::endl;
    }
